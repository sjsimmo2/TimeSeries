...
```{python fitting ARIMA in Python}
...
### Looks stationary (no trend and no random walk)
## This version needs a stationary time series!
res1 = sm.tsa.arma_order_select_ic(max2, max_ar=5, max_ma=5,ic="bic", trend="c")
res1.bic_min_order
